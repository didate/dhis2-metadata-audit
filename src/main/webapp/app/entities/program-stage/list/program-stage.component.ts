...
export class ProgramStageComponent implements OnInit {
  ...
  delete(programStage: IProgramStage): void {
    const modalRef = this.modalService.open(ProgramStageDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.programStage = programStage;
