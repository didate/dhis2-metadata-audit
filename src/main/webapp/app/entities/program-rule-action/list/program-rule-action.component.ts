...
@Component({
  ...
  templateUrl: './program-rule-action.component.html',
  imports: [
    RouterModule,
    FormsModule,
    SharedModule,
...
export class ProgramRuleActionComponent implements OnInit {
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.programRuleActionService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
