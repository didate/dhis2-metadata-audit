...
describe('OptionSet Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'optionset', component: OptionsetComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.optionsets?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
