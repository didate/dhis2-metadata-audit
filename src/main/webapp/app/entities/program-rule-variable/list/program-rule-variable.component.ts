...
@Component({
  standalone: true,
  selector: 'jhi-program-rule-variable',
  templateUrl: './program-rule-variable.component.html',
  imports: [
    RouterModule,
    FormsModule,
    SharedModule,
...
export class ProgramRuleVariableComponent implements OnInit {
  ...
  delete(programRuleVariable: IProgramRuleVariable): void {
    const modalRef = this.modalService.open(ProgramRuleVariableDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.programRuleVariable = programRuleVariable;
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.programRuleVariableService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
