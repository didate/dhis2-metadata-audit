...
import { sampleWithRequiredData } from '../option-group.test-samples';
import { OptionGroupService } from '../service/option-group.service';

import { OptionGroupComponent } from './option-group.component';
import SpyInstance = jest.SpyInstance;

describe('OptionGroup Management Component', () => {
  let comp: OptionGroupComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(OptionGroupComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.optionGroups?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

  describe('trackId', () => {
    it('Should forward to optionGroupService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getOptionGroupIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getOptionGroupIdentifier).toHaveBeenCalledWith(entity);
