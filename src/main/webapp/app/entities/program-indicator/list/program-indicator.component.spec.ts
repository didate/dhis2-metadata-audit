...
import { sampleWithRequiredData } from '../program-indicator.test-samples';
...
describe('ProgramIndicator Management Component', () => {
  let comp: ProgramIndicatorComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [ProgramIndicatorComponent],
      providers: [
        provideHttpClient(),
        {
      ...
      .overrideTemplate(ProgramIndicatorComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.programIndicators?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

  describe('trackId', () => {
    it('Should forward to programIndicatorService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getProgramIndicatorIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getProgramIndicatorIdentifier).toHaveBeenCalledWith(entity);
