...
public class IndicatortypeResource {
    ...
    private static final Logger log = LoggerFactory.getLogger(IndicatortypeResource.class);
    ...
    public ResponseEntity<Indicatortype> createIndicatortype(@Valid @RequestBody Indicatortype indicatortype) throws URISyntaxException {
        ...
        indicatortype = indicatortypeService.save(indicatortype);
        return ResponseEntity.created(new URI("/api/indicatortypes/" + indicatortype.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, indicatortype.getId()))
            .body(indicatortype);
    }
    ...
    public ResponseEntity<Indicatortype> updateIndicatortype(
        ...
        indicatortype = indicatortypeService.update(indicatortype);
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Indicatortype>> getAllIndicatortypes(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<Indicatortype> getIndicatortype(@PathVariable("id") String id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteIndicatortype(@PathVariable("id") String id) {
