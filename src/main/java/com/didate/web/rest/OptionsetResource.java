...
public class OptionsetResource {
    ...
    private static final Logger log = LoggerFactory.getLogger(OptionsetResource.class);
    ...
    public ResponseEntity<Optionset> createOptionset(@Valid @RequestBody Optionset optionset) throws URISyntaxException {
        ...
        optionset = optionsetService.save(optionset);
        return ResponseEntity.created(new URI("/api/optionsets/" + optionset.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, optionset.getId()))
            .body(optionset);
    }
    ...
    public ResponseEntity<Optionset> updateOptionset(
        ...
        optionset = optionsetService.update(optionset);
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Optionset>> getAllOptionsets(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<Optionset> getOptionset(@PathVariable("id") String id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteOptionset(@PathVariable("id") String id) {
