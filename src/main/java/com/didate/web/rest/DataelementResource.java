...
public class DataelementResource {
    ...
    private static final Logger log = LoggerFactory.getLogger(DataelementResource.class);
    ...
    public ResponseEntity<Dataelement> createDataelement(@Valid @RequestBody Dataelement dataelement) throws URISyntaxException {
        ...
        dataelement = dataelementService.save(dataelement);
        return ResponseEntity.created(new URI("/api/dataelements/" + dataelement.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, dataelement.getId()))
            .body(dataelement);
    }
    ...
    public ResponseEntity<Dataelement> updateDataelement(
        ...
        dataelement = dataelementService.update(dataelement);
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<Dataelement>> getAllDataelements(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<Dataelement> getDataelement(@PathVariable("id") String id) {
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteDataelement(@PathVariable("id") String id) {
