...
public class CategoryCombo implements Serializable, Persistable<String> {
    ...
    public CategoryCombo track(TypeTrack track) {
        this.setTrack(track);
        return this;
    }
    ...
    public CategoryCombo shortName(String shortName) {
    ...
    public CategoryCombo created(Instant created) {
    ...
    public CategoryCombo lastUpdated(Instant lastUpdated) {
    ...
    public CategoryCombo project(Project project) {
    ...
    public CategoryCombo createdBy(DHISUser dHISUser) {
    ...
    public CategoryCombo lastUpdatedBy(DHISUser dHISUser) {
