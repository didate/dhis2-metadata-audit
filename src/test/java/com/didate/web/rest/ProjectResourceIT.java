...
class ProjectResourceIT {
    ...
    private static final String DEFAULT_DHIS_2_URL = "AAAAAAAAAA";
    private static final String UPDATED_DHIS_2_URL = "BBBBBBBBBB";

    private static final Double DEFAULT_DHIS_2_VERSION = 1D;
    private static final Double UPDATED_DHIS_2_VERSION = 2D;
